...
public class KDTree implements PointSet {
    ...
    private Node nearest(Node node, Point goal, Node best, char axis) {
        ...
        /**
         * Check if need to prune the bad side or not. Here we use the "green line" approach as suggested
         * in the video. axisDifference is squared because the Point class's distance() method computes
